...
public class ProgrammeCoursesView extends View<Course> {
    //what is there to change ??
    // only adding rows to a table


    private static final String htmlFile = "public/views/ProgrammeCourses.html";

    private String filePath;

    protected ProgrammeCoursesView(String filePath) {
        this.filePath = filePath;
    }

    public ProgrammeCoursesView() {
